...
class QRemoteObjectAbstractPersistedStore(QtCore.QObject):
    ...
    def restoreProperties(self, repName: typing.Optional[str], repSig: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]) -> typing.List[typing.Any]: ...
    def saveProperties(self, repName: typing.Optional[str], repSig: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview], values: typing.Iterable[typing.Any]) -> None: ...
