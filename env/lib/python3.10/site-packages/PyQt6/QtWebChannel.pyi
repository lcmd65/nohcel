...
class QWebChannelAbstractTransport(QtCore.QObject):
    ...
    def sendMessage(self, message: typing.Dict[typing.Optional[str], typing.Union[QtCore.QJsonValue, QtCore.QJsonValue.Type, typing.Iterable[QtCore.QJsonValue], bool, int, float, None, typing.Optional[str]]]) -> None: ...
