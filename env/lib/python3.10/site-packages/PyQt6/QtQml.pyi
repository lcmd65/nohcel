...
class QJSEngine(QtCore.QObject):
    ...
    def evaluate(self, program: typing.Optional[str], fileName: typing.Optional[str] = ..., lineNumber: int = ..., exceptionStackTrace: typing.Optional[typing.List[str]] = ...) -> 'QJSValue': ...
...
class QQmlEngine(QJSEngine):
    ...
    @typing.overload
    def singletonInstance(self, moduleName: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], typeName: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> QtCore.QObject: ...
...
class QQmlApplicationEngine(QQmlEngine):
    ...
    @typing.overload
    def __init__(self, uri: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], typeName: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], parent: typing.Optional[QtCore.QObject] = ...) -> None: ...

    objectCreationFailed: typing.ClassVar[QtCore.pyqtSignal]
    objectCreated: typing.ClassVar[QtCore.pyqtSignal]
    def loadFromModule(self, uri: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], typeName: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> None: ...
...
class QQmlComponent(QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, engine: typing.Optional[QQmlEngine], uri: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], typeName: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    @typing.overload
    def __init__(self, engine: typing.Optional[QQmlEngine], uri: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], typeName: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], mode: 'QQmlComponent.CompilationMode', parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    @typing.overload
    def __init__(self, parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    ...
    def loadFromModule(self, uri: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], typeName: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], mode: 'QQmlComponent.CompilationMode' = ...) -> None: ...
