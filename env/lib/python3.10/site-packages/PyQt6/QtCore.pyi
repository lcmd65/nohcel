...
class QObject(PyQt6.sip.wrapper):
    ...
    def setObjectName(self, name: typing.Union['QByteArray', bytes, bytearray, memoryview, typing.Optional[str]]) -> None: ...
    def objectName(self) -> str: ...
    @typing.overload
    def findChildren(self, type: typing.Type[QObjectT], name: typing.Optional[str] = ..., options: Qt.FindChildOption = ...) -> typing.List[QObjectT]: ...
    @typing.overload
    def findChildren(self, types: typing.Tuple[typing.Type[QObjectT], ...], name: typing.Optional[str] = ..., options: Qt.FindChildOption = ...) -> typing.List[QObjectT]: ...
    @typing.overload
    ...
    @typing.overload
    def findChild(self, type: typing.Type[QObjectT], name: typing.Optional[str] = ..., options: Qt.FindChildOption = ...) -> QObjectT: ...
    @typing.overload
    def findChild(self, types: typing.Tuple[typing.Type[QObjectT], ...], name: typing.Optional[str] = ..., options: Qt.FindChildOption = ...) -> QObjectT: ...
    @staticmethod
...
class QCalendar(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> None: ...
    @typing.overload
...
class QDataStream(QIODeviceBase):
    ...
    @typing.overload
    def __lshift__(self, a0: 'QJsonValue') -> 'QDataStream': ...
    @typing.overload
    ...
    @typing.overload
    def __lshift__(self, p: 'QVariant') -> 'QDataStream': ...
    @typing.overload
    ...
    @typing.overload
    def __rshift__(self, a0: 'QJsonValue') -> 'QDataStream': ...
    @typing.overload
    ...
    @typing.overload
    def __rshift__(self, p: 'QVariant') -> 'QDataStream': ...
    @typing.overload
    ...
    def writeQVariantMap(self, qvarmap: typing.Dict[typing.Optional[str], typing.Any]) -> None: ...
    ...
    def writeInt8(self, i: bytes) -> None: ...
...
class QDir(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def entryInfoList(self, nameFilters: typing.Iterable[typing.Optional[str]], filters: 'QDir.Filter' = ..., sort: 'QDir.SortFlag' = ...) -> typing.List['QFileInfo']: ...
    @typing.overload
    def entryList(self, filters: 'QDir.Filter' = ..., sort: 'QDir.SortFlag' = ...) -> typing.List[str]: ...
    @typing.overload
    def entryList(self, nameFilters: typing.Iterable[typing.Optional[str]], filters: 'QDir.Filter' = ..., sort: 'QDir.SortFlag' = ...) -> typing.List[str]: ...
    @staticmethod
...
class QDirIterator(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, path: typing.Optional[str], nameFilters: typing.Iterable[typing.Optional[str]], filters: QDir.Filter = ..., flags: 'QDirIterator.IteratorFlag' = ...) -> None: ...
...
class QJsonDocument(PyQt6.sip.simplewrapper):
    ...
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, object: typing.Dict[typing.Optional[str], typing.Union['QJsonValue', 'QJsonValue.Type', typing.Iterable['QJsonValue'], bool, int, float, None, typing.Optional[str]]]) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def __getitem__(self, key: typing.Optional[str]) -> 'QJsonValue': ...
    def swap(self, other: 'QJsonDocument') -> None: ...
    def isNull(self) -> bool: ...
    def __ne__(self, other: object): ...
    def __eq__(self, other: object): ...
    def setArray(self, array: typing.Iterable['QJsonValue']) -> None: ...
    def setObject(self, object: typing.Dict[typing.Optional[str], typing.Union['QJsonValue', 'QJsonValue.Type', typing.Iterable['QJsonValue'], bool, int, float, None, typing.Optional[str]]]) -> None: ...
...
class QJsonValue(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, other: typing.Union['QJsonValue', 'QJsonValue.Type', typing.Iterable['QJsonValue'], bool, int, float, None, typing.Optional[str]]) -> None: ...
    ...
    @typing.overload
    def toObject(self, defaultValue: typing.Dict[typing.Optional[str], typing.Union['QJsonValue', 'QJsonValue.Type', typing.Iterable['QJsonValue'], bool, int, float, None, typing.Optional[str]]]) -> typing.Dict[str, 'QJsonValue']: ...
    @typing.overload
...
class QProcess(QIODevice):
    ...
    @typing.overload
    def start(self, program: typing.Optional[str], arguments: typing.Iterable[typing.Optional[str]] = ..., mode: QIODeviceBase.OpenModeFlag = ...) -> None: ...
    @typing.overload
...
class QRegularExpressionMatch(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def hasCaptured(self, name: typing.Optional[str]) -> bool: ...
    @typing.overload
...
class QSettings(QObject):
    ...
    def contains(self, key: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> bool: ...
    def remove(self, key: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> None: ...
    def value(self, key: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], defaultValue: typing.Any = ..., type: type = ...) -> typing.Any: ...
    def setValue(self, key: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], value: typing.Any) -> None: ...
    def isWritable(self) -> bool: ...
    ...
    def beginWriteArray(self, prefix: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], size: int = ...) -> None: ...
    def beginReadArray(self, prefix: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> int: ...
    def group(self) -> str: ...
    def endGroup(self) -> None: ...
    def beginGroup(self, prefix: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> None: ...
...
class QStandardPaths(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def locateAll(type: 'QStandardPaths.StandardLocation', fileName: typing.Optional[str], options: 'QStandardPaths.LocateOption' = ...) -> typing.List[str]: ...
    @staticmethod
...
class QStringConverter(QStringConverterBase):
    ...
    @typing.overload
    def __init__(self, name: typing.Optional[str], f: QStringConverterBase.Flag) -> None: ...
...
class QStringEncoder(QStringConverter):
    ...
    @typing.overload
    def __init__(self, name: typing.Optional[str], flags: QStringConverterBase.Flag = ...) -> None: ...
...
class QTimeZone(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    @staticmethod
    def windowsIdToIanaIds(windowsId: typing.Union[QByteArray, bytes, bytearray, memoryview]) -> typing.List[QByteArray]: ...
    @typing.overload
    @staticmethod
    def windowsIdToIanaIds(windowsId: typing.Union[QByteArray, bytes, bytearray, memoryview], territory: QLocale.Country) -> typing.List[QByteArray]: ...
    @typing.overload
    @staticmethod
...
class QUrl(PyQt6.sip.simplewrapper):
    ...
    def detach(self) -> None: ...
    @staticmethod
    def fromEncoded(u: typing.Union[QByteArray, bytes, bytearray, memoryview], mode: 'QUrl.ParsingMode' = ...) -> 'QUrl': ...
    @typing.overload
...
class QUrlQuery(PyQt6.sip.simplewrapper):
    ...
    def allQueryItemValues(self, key: typing.Optional[str], options: QUrl.ComponentFormattingOption = ...) -> typing.List[str]: ...
...
class QUuid(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, string: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> None: ...
    @typing.overload
    ...
    @staticmethod
    def fromString(string: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> 'QUuid': ...
    @staticmethod
...
class QVersionNumber(PyQt6.sip.simplewrapper):
    ...
    def __hash__(self) -> int: ...
    @staticmethod
    def fromString(string: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> typing.Tuple['QVersionNumber', typing.Optional[int]]: ...
    def toString(self) -> str: ...
    @staticmethod
...
class QTypeRevision(PyQt6.sip.simplewrapper):
    ...
    def isValid(self) -> bool: ...
    def minorVersion(self) -> bytes: ...
    def hasMinorVersion(self) -> bool: ...
    def majorVersion(self) -> bytes: ...
...
class QXmlStreamReader(PyQt6.sip.simplewrapper):
    ...
    def __init__(self, device: typing.Optional[QIODevice]) -> None: ...
    @typing.overload
    def __init__(self, data: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> None: ...
    ...
    def atEnd(self) -> bool: ...
    def clear(self) -> None: ...
    def addData(self, data: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> None: ...
    def device(self) -> typing.Optional[QIODevice]: ...
    def setDevice(self, device: typing.Optional[QIODevice]) -> None: ...
...
class QXmlStreamWriter(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def writeStartElement(self, namespaceUri: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], name: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> None: ...
    @typing.overload
    def writeStartElement(self, qualifiedName: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> None: ...
    @typing.overload
    def writeStartDocument(self, version: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], standalone: bool) -> None: ...
    @typing.overload
    def writeStartDocument(self, version: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> None: ...
    @typing.overload
    def writeStartDocument(self) -> None: ...
    def writeProcessingInstruction(self, target: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], data: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]] = ...) -> None: ...
    def writeDefaultNamespace(self, namespaceUri: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> None: ...
    def writeNamespace(self, namespaceUri: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], prefix: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]] = ...) -> None: ...
    def writeEntityReference(self, name: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> None: ...
    def writeEndElement(self) -> None: ...
    def writeEndDocument(self) -> None: ...
    @typing.overload
    def writeTextElement(self, namespaceUri: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], name: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], text: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> None: ...
    @typing.overload
    def writeTextElement(self, qualifiedName: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], text: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> None: ...
    @typing.overload
    def writeEmptyElement(self, namespaceUri: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], name: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> None: ...
    @typing.overload
    def writeEmptyElement(self, qualifiedName: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> None: ...
    def writeDTD(self, dtd: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> None: ...
    def writeComment(self, text: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> None: ...
    def writeCharacters(self, text: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> None: ...
    def writeCDATA(self, text: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> None: ...
    def writeAttributes(self, attributes: 'QXmlStreamAttributes') -> None: ...
    @typing.overload
    def writeAttribute(self, namespaceUri: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], name: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], value: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> None: ...
    @typing.overload
    def writeAttribute(self, qualifiedName: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]], value: typing.Union[QByteArray, bytes, bytearray, memoryview, typing.Optional[str]]) -> None: ...
    @typing.overload
...
def qInstallMessageHandler(a0: typing.Optional[typing.Optional[typing.Callable[[QtMsgType, QMessageLogContext, typing.Optional[str]], None]]]) -> typing.Optional[typing.Callable[[QtMsgType, QMessageLogContext, str], None]]: ...
