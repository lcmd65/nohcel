...
class QOpenGLFunctions_2_0(QAbstractOpenGLFunctions):
    ...
    def glGetColorTableParameterfv(self, target: int, pname: int) -> typing.Optional[typing.Union[float, typing.Tuple[float, float, float, float]]]: ...
    def glGetColorTableParameteriv(self, target: int, pname: int) -> typing.Optional[typing.Union[int, typing.Tuple[int, int, int, int]]]: ...
    ...
    def glGetConvolutionParameterfv(self, target: int, pname: int) -> typing.Optional[typing.Union[float, typing.Tuple[float, float, float, float]]]: ...
    def glGetConvolutionParameteriv(self, target: int, pname: int) -> typing.Optional[typing.Union[int, typing.Tuple[int, int, int, int]]]: ...
    ...
    def glGetClipPlane(self, plane: int) -> typing.Optional[typing.Tuple[float, float, float, float]]: ...
    def glGetLightfv(self, light: int, pname: int) -> typing.Optional[typing.Union[float, typing.Tuple[float, float, float], typing.Tuple[float, float, float, float]]]: ...
    def glGetLightiv(self, light: int, pname: int) -> typing.Optional[typing.Union[int, typing.Tuple[int, int, int], typing.Tuple[int, int, int, int]]]: ...
    def glGetMaterialfv(self, face: int, pname: int) -> typing.Optional[typing.Union[float, typing.Tuple[float, float, float], typing.Tuple[float, float, float, float]]]: ...
    def glGetMaterialiv(self, face: int, pname: int) -> typing.Optional[typing.Union[int, typing.Tuple[int, int, int], typing.Tuple[int, int, int, int]]]: ...
    def glGetTexEnvfv(self, target: int, pname: int) -> typing.Optional[typing.Union[float, typing.Tuple[float, float, float, float]]]: ...
    def glGetTexEnviv(self, target: int, pname: int) -> typing.Optional[typing.Union[int, typing.Tuple[int, int, int, int]]]: ...
    def glGetTexGendv(self, coord: int, pname: int) -> typing.Optional[typing.Union[float, typing.Tuple[float, float, float, float]]]: ...
    def glGetTexGenfv(self, coord: int, pname: int) -> typing.Optional[typing.Union[float, typing.Tuple[float, float, float, float]]]: ...
    def glGetTexGeniv(self, coord: int, pname: int) -> typing.Optional[typing.Union[int, typing.Tuple[int, int, int, int]]]: ...
    ...
    def glGetProgramiv(self, program: int, pname: int) -> typing.Optional[typing.Union[int, typing.Tuple[int, int, int]]]: ...
    ...
    def glGetVertexAttribdv(self, index: int, pname: int) -> typing.Optional[typing.Union[float, typing.Tuple[float, float, float, float]]]: ...
    def glGetVertexAttribfv(self, index: int, pname: int) -> typing.Optional[typing.Union[float, typing.Tuple[float, float, float, float]]]: ...
    def glGetVertexAttribiv(self, index: int, pname: int) -> typing.Optional[typing.Union[int, typing.Tuple[int, int, int, int]]]: ...
    ...
    def glGenQueries(self, n: int) -> typing.Optional[typing.Union[int, typing.Tuple[int, ...]]]: ...
    ...
    def glGenBuffers(self, n: int) -> typing.Optional[typing.Union[int, typing.Tuple[int, ...]]]: ...
    ...
    def glGenTextures(self, n: int) -> typing.Optional[typing.Union[int, typing.Tuple[int, ...]]]: ...
    ...
    def glGetBooleanv(self, pname: int) -> typing.Optional[typing.Union[bool, typing.Tuple[bool, ...]]]: ...
    def glGetDoublev(self, pname: int) -> typing.Optional[typing.Union[float, typing.Tuple[float, ...]]]: ...
    def glGetError(self) -> int: ...
    def glGetFloatv(self, pname: int) -> typing.Optional[typing.Union[float, typing.Tuple[float, ...]]]: ...
    def glGetIntegerv(self, pname: int) -> typing.Optional[typing.Union[int, typing.Tuple[int, ...]]]: ...
    def glGetString(self, name: int) -> typing.Optional[str]: ...
    def glGetTexParameterfv(self, target: int, pname: int) -> typing.Optional[typing.Union[float, typing.Tuple[float, float, float, float]]]: ...
    def glGetTexParameteriv(self, target: int, pname: int) -> typing.Optional[typing.Union[int, typing.Tuple[int, int, int, int]]]: ...
